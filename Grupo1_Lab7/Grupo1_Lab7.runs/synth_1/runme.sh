...
HD_PWD='C:/Users/HP/OneDrive/Documentos/MARCELO/UCB/Circuitos Digitales/Grupo1_Lab7/Grupo1_Lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Flip_Flop_D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Flip_Flop_D.tcl
