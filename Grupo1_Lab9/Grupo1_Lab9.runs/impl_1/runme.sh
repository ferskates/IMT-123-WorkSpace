...
HD_PWD='C:/Users/HP G4/Desktop/LABORATORIOS DIGITAL/Grupo1_Lab9/Grupo1_Lab9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ContPrim.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ContPrim.tcl -notrace
