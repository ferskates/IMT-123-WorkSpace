...
HD_PWD='C:/Users/HP G4/Desktop/LABORATORIOS DIGITAL/Grupo1_Lab9/Grupo1_Lab9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ContPrim.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ContPrim.tcl
